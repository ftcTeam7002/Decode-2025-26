...
public class pedroAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(21.3, 121.5, Math.toRadians(135)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(37, 108, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
